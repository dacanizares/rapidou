...
- `./run/install-opensource.sh` installs and configures a local Qwen Code/Ollama stack without a cloud account, preserves unrelated user settings, and verifies a headless JSON prompt in a temporary directory.
